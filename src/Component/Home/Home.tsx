        ...
        <Row className="secrow1">
          <Col md={8} className="secrow2">
            ...
            <div className="home4">
              ...
              marketplace, allowing for P2P energy trading to occur efficiently
              between the involved parties, without the need for an
              intermediary.
            </div>
          </Col>
        </Row>
                ...
                <div className="card2wrapper">
                  ...
                  <div>
                    <img
                      ...
                      alt="howitworksimage"
                    />
                    <div className="steptext">View all available products</div>
                  </div>
                </div>
                <div className="card2wrapper">
        ...
        <Row className="thirdrow1 shiftbottom1">
          <Col md={12} className="thirdrow4a">
            ...
            <div className="icontray">
              <img src={Paystack} className="iconpaystack" alt="iconmonnify" />
              <img
                src={Monnify}
                className="iconmonnify"
                alt="iconmonnify"
              />{" "}
